...
namespace Niga_Domain.API.Controllers
{
    ...
    public class RepertorizationPageController : ControllerBase
    {
        ...
        private readonly Niga_Domain.Data.NIGACentrumContext _context;

        public RepertorizationPageController(
            IRepertorizationPageService _repertorizationPageService,
            Niga_Domain.Data.NIGACentrumContext context)
        {
        ...
        {
            var deny = Niga_Domain.Security.DoctorOwnership.ForbidIfReception(User);
            if (deny != null)
                return deny;
            ...
            var jwtDoctor = Niga_Domain.Security.DoctorOwnership.GetDoctorId(User);
            ...
            if (doctorId > 0)
            {
                _context.CogRuns.Add(new Niga_Domain.Master.CogRun
                {
                    DoctorId = doctorId,
