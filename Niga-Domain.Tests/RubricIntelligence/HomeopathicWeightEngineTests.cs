...
public class HomeopathicWeightEngineTests
{
    ...
    {
        public List<Niga_Domain.Master.HomeopathicWeightRule> Rules { get; set; } = new();
        ...
        public Task<List<Niga_Domain.Master.HomeopathicWeightRule>> GetActiveWeightRulesAsync(CancellationToken cancellationToken = default)
