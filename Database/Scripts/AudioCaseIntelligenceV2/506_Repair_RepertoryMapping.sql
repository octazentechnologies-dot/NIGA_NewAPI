-- Phase 7 REPAIR: widen columns + re-populate RubricRepertoryMap
-- Safe to re-run (idempotent). Tables 011/012 must already exist.
-- Run on HomeoCentrum_Production when KentMaps/CompleteMaps are 0 or Msg 2628 truncation occurs.

/* STEP 1 — widen SourceRubricKey / SourceRubricPath (fixes Msg 2628) */
...
/* STEP 2 — seed / repair Kent + Complete mappings */
