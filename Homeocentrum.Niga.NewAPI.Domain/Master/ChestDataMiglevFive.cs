...
public partial class ChestDataMiglevFive
{
    public string? Section { get; set; }

    public string? TypeofSymptoms { get; set; }

    public double? IdsymptomwithBodyPart { get; set; }

    public string? SymptomwithBodyPart { get; set; }

    public double? ParentIdLocation { get; set; }

    public string? IdsymptomswithLocation { get; set; }

    public string? SymptomswithLocation { get; set; }

    public string? ParantFive { get; set; }
