...
INSERT INTO @Users (RoleName, UserName, EmailId, FirstName, LastName, MobileNo) VALUES
    ...
    (N'Patient',          N'Tufan_Patient',   N'tufan.patient@homeocentrum.dev',   N'Tufan', N'Patient',   N'9000000205'),
...
BEGIN
    ...
    VALUES (
        ...
        N'Tufan team clinic',
        N'9000000207',
        N'tufan.reception@homeocentrum.dev',
...
BEGIN
    ...
    BEGIN
        ...
        VALUES (
            ...
            N'Tufan team',
            14, 78, N'9000000205',
            '1990-01-01', 0, N'tufan.patient@homeocentrum.dev',
    ...
    END
    ELSE
        PRINT CONCAT('SKIP Patient already mapped PatientId=', @PatientId);
END
...
PRINT 'UserMaster: Tufan_Admin Tufan_Doctore Tufan_Account Tufan_Pharmacy Tufan_Patient Tufan_Caregiver';
